export default {
  ...
  invalidJwt: 'Invalid JWT token format',
  invalidPassword: 'Invalid password',
  invalidUsername: 'Invalid username',
  lowBattMsg: 'Device has low battery - ',
  missingCreds: 'credentials missing from config',
  neo2JwtAuth: 'Using NEO 2.0 JWT authentication (skipping traditional login)',
  neo2TokenRefreshFail: 'NEO 2.0 token refresh failed with error',
  neo2TokenRefreshed: 'NEO 2.0 access token refreshed successfully',
